...
//        exit();
        ...
        if (isset($_POST['account'])){
            if($_POST['account'][0] == 'all'){
                $result = $this->ChartModel->get_account_name_2($_SESSION['comp']);
        ...
        foreach ($chart_ids as $chart_Key => $chart_id) {
            ...
            $Op_balances[$chart_Key] = $this->LinkModel->Get_OpeningBalance($from,$chart_id);
