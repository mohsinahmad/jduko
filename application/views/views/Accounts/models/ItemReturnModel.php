...
class ItemReturnModel extends CI_Model
{
    ...
    {
        $this->db->select('users.UserName,item_demand_form.Form_Number as demand_no,item_issue.Id,item_issue.Issued_DateG,item_issue.Demand_Form_Id,item_issue.Issued_DateH,item_issue.Remarks, item_issue.Form_Number,item_issue.Status, item_issue.is_returned,item_issue.Receive_Slip_Id');
        ...
        $this->db->join('item_demand_form', 'item_demand_form.id = item_issue.Demand_Form_Id');
        if ($is_direct != '') {
