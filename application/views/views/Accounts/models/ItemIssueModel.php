...
class ItemIssueModel extends CI_Model {
    ...
    {
        $this->db->select('item_issue.Id,item_issue.Status,item_demand_form.Form_Number as issue_form,unit_of_measure.name as unit,item_issue.Form_Number,item_setup.name,item_issue.Issued_DateG,item_issue.Issued_DateH,item_issue.Remarks');
        $this->db->from('item_issue');
        $this->db->join('item_issue_details', 'item_issue.Id=item_issue_details.Item_Issue_Id');
        $this->db->join('item_setup', 'item_issue_details.Item_Id=item_setup.Id');
