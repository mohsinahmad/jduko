    ...
    public function s_CheckVocher(){
      ...
      //  echo $reportdate;
       ...
       // echo $this->db->last_query();
        ...
        if (isset($GetSaveVoucher)){
            foreach ($GetSaveVoucher as $D_key => $datum) {
                foreach ($datum as $d_value) {
                    $bookAmountSave[] = $this->BookModel->get_book_Amount($d_value->VoucherType,$d_value->VoucherNo,$d_value->LevelID,$d_value->Seprate_series_num);
                }
            }
        }
        if(isset($GetSaveVoucher)){
...
//       echo '<pre>';
//        print_r($_POST['getvouchers']);
//        print_r($_POST['voucherNo']);
//        echo '</pre>';
            foreach ($_POST['getvouchers'] as $key => $value) {
//            if(isset($_POST['voucherNo'][$key])){
...
//            echo '<pre>'.$this->db->last_query().'</pre><br>'.$key;
//            echo $key;
