...
<form role ="from" action="<?php echo site_url('Accounts/BalanceSheet/Get_Consolidated_BalanceSheet')?>" method="POST" target="_blank" id="UserInput">
    <br><h1 style="text-align: center;">مشترکہ بیلنس شیٹ</h1><br><br>
