        ...
        <div class="content">
            <div class="row" id="content">
                ...
                <div style="text-align: center;">
                    ...
                    <?php if ($Income_Of == 'p'){ ?>
                        <h2 style="font-size: 22px;margin-top: 15px;text-decoration: underline; ">آمدنی کا گوشوارہ<span style="font-size: 13px">(مستقل)</span></h2>
                    <?php }else{ ?>
                        <h2 style="font-size: 22px;margin-top: 15px;text-decoration: underline; ">آمدنی کا گوشوارہ<span style="font-size: 13px">(عارضی + مستقل)</span></h2>
                    <?php }?>
                    ...
                    <h4 style="font-size: 16px;"><p style="margin-right: -15%"><?php echo $from[0]->Sh_date?></p><p style="margin-right: 147px;margin-top: -29px;"><?php echo $from[0]->Qm_date;?></p></h4></div>
            </div>
            <div class="level">
                <div>
                    <div class="row two" style="padding-top: 0px">
                        <div class="col-lg-12">
                            ...
                            $balance_sum = 0; $total_balance = 0;
                            $t_id1 = array(); $t_id2 = array();
                            $balance = 0; $count = 0; $balance_new = 0; ?>
                            <?php foreach ($AccountTree as $acc_key => $Accounts){ ?>
                                <div class="panel-body">
                                    <div class="row">
                                        <?php if ($acc_key == 0){ ?>
                                            <div class="col-md-6">
                                                <input readonly class="level-name" type="tex" value="<?= $level[0]->LevelName?>">
                                            </div>
                                            <div class="col-md-6">
                                                        ...
                                                        if (isset($IsZero[$acc_key][$key_1])){
                                                            if ($IsZero[$acc_key][$key_1] == 'y' || $withOutZero == 0){?>
                                                                ...
                                                                <?php if ($level_1->Category == '2' || $account_level == 'Detail' || $account_level == '1'){
                                                                    ...
                                                                    }$balance_sum += $balance; $balance = 0; $count = $key_1; $ShowTotal = 1;
                                                                }else{?>
                                                                ...
                                                                if ($Links[$acc_key][$key_1][$key_2] == 'y'){
                                                                    if (isset($IsZero[$acc_key][$key_1][$key_2])){
                                                                        if ($IsZero[$acc_key][$key_1][$key_2] == 'y' || $withOutZero == 0){?>
                                                                            ...
                                                                            <td style="width: 35%; font-weight: bold;"><?= $level_2->AccountName?></td>
                                                                            <?php if ($level_2->Category == '2' || $account_level == '2'){
                                                                                ...
                                                                                }$balance_sum += $balance; $balance = 0; $count++; $ShowTotal = 1;
                                                                            }else{?>
                                                                                <td style="width: 15%;"></td>
                                                                            <?php }?>
                                                                            </tr>
                                                                        ...
                                                                        if ($Links[$acc_key][$key_1]['Child'.$key_2][$key_3] == 'y'){
                                                                            if (isset($IsZero[$acc_key][$key_1]['Child'.$key_2][$key_3])){
                                                                                if ($IsZero[$acc_key][$key_1]['Child'.$key_2][$key_3] == 'y' || $withOutZero == 0){?>
                                                                                    ...
                                                                                    <td style="width: 35%; font-weight: bold;"><?= $level_3->AccountName?></td>
                                                                                ...
                                                                                if ($Links[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3][$key_4] == 'y'){
                                                                                    if (isset($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3][$key_4])){
                                                                                        if ($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3][$key_4] == 'y' || $withOutZero == 0){?>
                                                                                            ...
                                                                                            <td style="width: 35%; font-weight: bold;"><?= $level_4->AccountName?></td>
                                                                                        ...
                                                                                        if ($Links[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4][$key_5] == 'y'){
                                                                                            if (isset($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4][$key_5])){
                                                                                                if ($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4][$key_5] == 'y' || $withOutZero == 0){?>
                                                                                                    ...
                                                                                                    <td style="width: 35%; font-weight: bold;"><?= $level_5->AccountName?></td>
                                                                                                ...
                                                                                                if ($Links[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4]['Child'.$key_5][$key_6] == 'y'){
                                                                                                    if (isset($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4]['Child'.$key_5][$key_6])){
                                                                                                        if ($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4]['Child'.$key_5][$key_6] == 'y' || $withOutZero == 0){?>
                                                                                                            ...
                                                                                                            <td style="width: 35%; font-weight: bold;"><?= $level_6->AccountName?></td>
                                                                                                            ...
                                                                                                            if (isset($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4]['Child'.$key_5]['Child'.$key_6][$key_7])){
                                                                                                                if ($IsZero[$acc_key][$key_1]['Child'.$key_2]['Child'.$key_3]['Child'.$key_4]['Child'.$key_5]['Child'.$key_6][$key_7] == 'y' || $withOutZero == 0){?>
                                                                                                                    <tr class="odd gradeX">
                                                                                                                        ...
                                                                                                                        <td style="width: 35%; font-weight: bold;"><?= $level_7->AccountName?></td>
                    ...
                    <div class="panel-body" style="direction: rtl;">
                        <div class="table-responsive" style="overflow-x: hidden;overflow-y: hidden;">
                            <table class="table-bordered" id="dataTables-example">
                                ...
                                <tr style="line-height: 250%;">
                                    <th></th>
                                    <th style="width: 24%;text-align: center">بیلینس</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr class="odd gradeX" style="line-height: 250%;">
                                    ...
                                    <?php if ($total_balance < 0){
                                        $total_balance_new = $total_balance * -1;?>
                                        <th style="text-align: center"><?= number_format($total_balance_new)?></th>
                                    <?php }else{?>
<!--                                        <pre>--><?php //echo $total_balance?><!--</pre>-->
                                        <th style="text-align: center">(<?= number_format($total_balance)?>)</th>
                                    <?php }?>
                                </tr>
                                </tbody>
                            </table>
