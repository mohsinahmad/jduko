            ...
            <div class="panel-body">
                <div class="table-responsive" style="width: 100%;">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                <th style="text-align: center;width: 80.021px;">ڈیمانڈ فارم نمبر</th>
                                <th style="text-align: center">شعبے کا نام</th>
<!--                                <th style="text-align: center">تعاوّن کی قسم</th>-->
                        ...
                        <?php }else{ ?>
                                <tr class="DemandItems" data-id='<?= $value->d_id?>'>
                                <?php } ?>
                                <td class="FormNumber" style="text-align: center"><?= $value->Form_Number?></td>
...
<!--                                <td style="text-align: center"></td>-->
                                ...
                                <td style="text-align: center"><?php if($status == 0) {?>
                                    ...
                                    <?php }else if($status == 3){?>
                                        <span class="label label-info" style="font-size: 0.9em;padding-top: 0px;padding-bottom: 0px;">کلوزنگ زیر التواء</span>
                                    <?php }?>
                                </td>
                            </tr>
                        <?php endforeach?>
                    ...
                    <table class="table table-striped table-bordered table-hover demand">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center">مطلوبہ مقدار</th>
                                <th style="text-align: center">موجودہ مقدار</th>
...
$(document).ready(function(){
   ...
   // $('#ApproveQuantity0').val($('#stock').val());
