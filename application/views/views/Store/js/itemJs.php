...
//                console.log(response);
    ...
    $('.Save').on('click',function(){
        var val  = $('.cb').parent('td').parent('tr').children('td').eq(6).find('input[type=number]').val();
...
//           alert(id);
                ...
                // var ApproveQ = $('.item_quantity'+i).val();
                // alert(quantity);
...
//            var detail = $('.seleted_item'+i+':checked').parent('td').parent('tr').children('td').eq(9).find('.detail'+i).val();
                //alert(detail);
                issue_post.detail_id = detal_id;
