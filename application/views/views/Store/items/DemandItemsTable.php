...
//                    console.log(result);
                    ...
                    $.each(result,function (index,value) {
                        tr += '<tr data-id="'+(result[index].issue_id)+'"><td>'+result[index].name+'</td>' +
                            ...
                            '<td><input type="checkbox" class="form-control cb seleted_item'+index+'" name="selected_items[]"></td>'+
                            '<td><input class="form-control item_quantity'+index+'" readonly type="number" placeholder="Quantity" name="selected_items_quantity[]"></td>'+
                            '<td style="display: none"><input class="donation'+index+'" value="'+result[index].donation_id+'" type="hidden"></td>'+
//                            '<td style="display: none"><input class="detail'+index+'" value="'+result[index].recieve_details_id+'" type="hidden"></td>'+
