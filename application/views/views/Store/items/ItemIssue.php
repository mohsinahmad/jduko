            ...
            <div class="panel-body">
                ...
                <input type="text" id="myInputTextField" style="float: left;"></label>
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                        <tr>
                            <th style="text-align: center;width: 90.021px;">ڈیمانڈ فارم نمبر</th>
                ...
                <div class="table-responsive" style="width: 100%;">
                    <table class="table table-striped table-bordered table-hover demand">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">تعاون کی قسم</th>
                        </tr>
                        </thead>
...
<div id="detail_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 90%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h1 style="margin-left: 100px">تفصیل:</h1>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <table id="issue_details" class="table table-striped table-bordered table-hover demand">
                        <thead>
                                <tr>
                                    <th>آئٹم</th>
                                    <th>تعاون کی قسم</th>
