                                    ...
                                    <table class="table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="float: right;">گاےَ تازہ</span>
                                                ...
                                                <span style="float: left;margin-left: 25%"> روپے</span>
                                            </td>
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Cow_Fresh * $Slip[0]->Fresh_Rate_Cow) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Cow_Old * $Slip[0]->Old_Rate_Cow) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Goat_Fresh * $Slip[0]->Fresh_Rate_Goat) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Goat_Old * $Slip[0]->Old_Rate_Goat) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Sheep_Fresh * $Slip[0]->Fresh_Rate_Sheep) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Sheep_Old * $Slip[0]->Old_Rate_Sheep) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Camel_Fresh * $Slip[0]->Fresh_Rate_Camel) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Camel_Old * $Slip[0]->Old_Rate_Camel) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo number_format($Slip[0]->Buffelo_Fresh * $Slip[0]->Fresh_Rate_Buffelo) ?></td>
                                            <?php }?>
                                        </tr>
                                        <tr>
