            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <input  class="form-control" id="ItemName" name="ItemName" style="width: 250px;" value="<?= $itemsToEdit[0]->p_name?>" type="text" placeholder="آئٹم کا نام" required>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="form-group">
                    ...
                    -->
                        <select class="form-control" id="unit_of_measure" style="height: 50px;" name="unit_of_measure" required>
                            <option selected value = "<?= $itemsToEdit[0]->id?>"><?= $itemsToEdit[0]->unit_of_measure_name?></option>
                            <?php foreach($unit as $unit_val):?>
                                <option value = "<?php echo $unit_val->id?>"> <?php echo $unit_val->name?></option>
                            <?php endforeach?>
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="form-group" style="width: 250px; align-content: center;">
                        ...
                        <select class="form-control" id="ItemCategory" style="height: 50px;" name="ItemCategory" required>
                            <?php foreach($categories as $category):?>
                                <option value = "<?php echo $category->parent_id?>"> <?php echo $category->parent_name?></option>
                            <?php endforeach?>
                            <?php foreach($allcategories as $category1):?>
                ...
                <div class="col-xs-4">
                    <div class="form-group" style="width: 250px; align-content: center;">
                        ...
                        <select class="form-control" required id="ItemsubCategory" style="height: 50px;" name="ItemsubCategory">
