            ...
            <div class="panel-body" style="padding: 0px;">
                <div class="container-fluid" >
                    <div class="table-responsive">
                     <center>
                        <table class="table-bordered" id="invoice_table">
                            <thead>
                            <tr>
                                <!--sufyan working-->
                                <th style="
...
">نام اشیاء</th>
                            ...
                            <?php foreach($return as $key => $value):?>
                                <tr>
                                    <td style="class="remarks" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $value->Item_remarks?></td>
                                    <td style="width: 15%; text-align: center" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $value->return_quantity;
                                        ...
                                        ?></td>
                                    <?php $usequantity = $ItemIssuedDetailed[$key]->Issue_Quantity - $value->return_quantity; ?>
                                    <td style="class="" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $usequantity;
                                        $totaluse += $usequantity;
                                        ?></td>
                                    <td style="class="" style="text-align: center;" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $ItemIssuedDetailed[$key]->Issue_Quantity;
                                        $totalissue += $ItemIssuedDetailed[$key]->Issue_Quantity;
                                        ?></td>
                          ...
                          <!--  <tr>
                                ...
                                <td style="text-align: center"><?php //number_format($totalreturn,2) ?></td>
                                <td><?php //number_format($totaluse,2) ?></td>
                                <td><?php //number_format($totalissue,2) ?></td>
                                <td style=""><b>:کل</b></td>
