                    ...
                    <table>
                        <tr class="form-horizontal">
                            ...
                            <td style="direction: rtl;float: right;">
                                ...
                                <p class="page-header vtitle">فارم نمبر:<?php
                        ...
                        <table id="invoice_table"  class="table-bordered">
                            ...
                            <?php foreach($IssueSlip as $key => $value):?>
                                <tr>
                                    ...
                                    <td style="text-align: center;" class="" style="text-align: center;" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $ApproveQuantity[$key]->Approve_Quantity;
