        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    ...
                    <label class="control-label" for="inputSuccess">پیمائش کی اکائی</label>
                    <select class="form-control UnitOfMeasure" name="UnitOfMeasure" style="width: 250px;height: 48px;" type="text" id="UnitOfMeasure" id="unit">
                        <option disabled selected value="">منتخب کریں</option>
