        ...
        <div class="content">
            <div class="row" id="content">
                ...
                <div style="text-align: center;">
                    ...
                    <?php if ($Income_Of == 'p'){ ?>
                        <h2 style="font-size: 22px;margin-top: 0px;text-decoration: underline; ">آمدنی کا گوشوارہ<span style="font-size: 13px">(مستقل)</span></h2>
                    <?php }else{ ?>
                        <h2 style="font-size: 22px;margin-top: 0px;text-decoration: underline; ">آمدنی کا گوشوارہ<span style="font-size: 13px">(عارضی + مستقل)</span></h2>
                    <?php }?>
