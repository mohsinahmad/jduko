...
زیرتحویل کیشیئر رقم مورخہ:
            ...
            <div class="row two">
                <div style="margin-right: 4%;">
                    <h5><span>زیر تحویل کیشیئر کی رقم مبلغ مورخہ </span><input type="text" class="VoucherMOdal" readonly style="font-family: 'Noto Nastaliq Urdu', serif; width: 230px;font-weight: bold;font-size: 1em;line-height: 0%" value="<?php echo $cashrecive?>"><span> تک اداشدہ واؤچر کی تفصیل درجہ ذیل ہیں</span></h5>
                </div>
            </div>
            <div class="panel-body two" style="direction: rtl;">
                <div class="table-responsive" style="overflow-x: hidden;overflow-y: hidden;">
                    <table class="table-bordered" id="dataTables-example">
                        ...
                        <tr style="line-height: 250%;">
                            ...
                            <th style="text-align: center;width: 48%;">مصارف کی تفصیل</th>
                        ...
                        <?php foreach($exvoucher as $key => $value){?>
                            <tr class="odd gradeX" style="line-height: 150%;">
                                <td class="center" style="text-align: center;"><?php echo $value[1].'-'.$value[0]?></td>
                                <td style="text-align: center;"><?php echo  $value[3]?> - <?php echo  $value[2]?></td>
                ...
                <div class="table-responsive totaltable" style="overflow-x: hidden;overflow-y: hidden;">
                    <table class="table-bordered" id="dataTables-example">
                        ...
                        <tr>
                            ...
                            <th style="line-height: 32px;width: 48%;"><span style="float: left;">
                                   میزان ادائیگی:
                                    </span></th>
                        ...
                        <tr>
                            ...
                            <th style="line-height: 32px;width: 48%;"><span style="float: left;">
                                موجودہ بیلنس:
                                <span></th>
                            <th><?php echo number_format($final_total)?></th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
                <div style="margin-top: 50px;">
                    ...
                    <div style="margin-top: -3.5%;margin-right: 22%">
                        <label class="label-control">ڈپٹی چیف اکاؤنٹنٹ
                        </label>
                        <input type="text" style="width: 25%" class="VoucherMOdal" value="">
                    </div>
                    <div style="margin-top: -3.5%;margin-right: 57%;">
                        <label class="label-control">
                            خازن﴿اعزازی﴾ دارالعلوم کراچی
                            </label>
                        <input type="text" style="width: 39%" class="VoucherMOdal" value="">
                    </div>
                </div>
            </div>
        </div>
