...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .tableborderss>thead>tr>th,.tableborderss>tbody>tr>td,.tableborderss>tfoot>tr>th{
...
<div class="content">
    <div class="row" id="content">
        ...
        <div style="text-align: center;margin-top: -2%;">
            <img src="<?= base_url()?>assets/images/logo.jpg" align="middle" style="width:25%; max-width:330px;">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">تاریخ<span style="margin-right: 2px;">:</span>
                    <?php if ($P_month == '01') { $P_month_inwords = 'محرم‬';
            ...
            <div class="row two">
                <div class="col-lg-12">
                    <div class="panel-body" style="margin-bottom: -5%;">
                        <div class="row" style="margin-top: -1%;margin-right: -5%;">
                            <div class="col-md-12">
                                ...
                                <h5 style="">رپورٹ برائے وصولیاں و مصارف و کیش وبینک بیلنس بابت <span style="font-weight: bold;"><?php echo$To;?>ھ</span> تا <span style="font-weight: bold;"><?php echo$From;?>ھ</span> پیش خدمت ہے</h5>
                            </div>
                        </div><br>
                    </div><br>
                    <div class="table-responsive" align="middle" style="width: 100%;text-align: center; margin-right: -0%;overflow-x: hidden;overflow-y: hidden;">
                        <table class="table-bordered tableborderss">
                            <thead>
                            <tr>
                            ...
                            <?php $newClosBal = $ClosBal = 0; $TotalIncome = 0;$TotalExpense = 0;$TotalDiff = 0;$TotalD1 = 0;$TotalD2 = 0;$TotalCapital = 0;$Nototal = 0;
                                ...
                                <?php if(!($with_zero == 1 && $IncTransaction['ClosingBalance'][0] == 0 && $IncTransaction[0][0]->Credit == 0 && $IncTransaction[$key][0][0]->Debit == 0 && $IncTransaction['ClosingBalance'][1] == 0)):?>
                                    <tr>
                                        ...
                                        <?php if(is_array($IncTransaction['ClosingBalance'])){ ?>
                                            <?php  if ($IncTransaction['ClosingBalance'][0] == 0) {
                                                $ClosBal = '-';
                                            }else{
                                                $ClosBal = $IncTransaction['ClosingBalance'][0];
                                            } ?>
                                            <?php if($ClosBal < 0){
                                                $newClosBal = ($ClosBal * -1);?>
                                                <td style="text-align: center;">(<?= number_format($newClosBal);?>)</td>
                                            <?php } else{ ?>
                                                <td style="text-align: center;"><?= number_format($ClosBal);?></td>
