<form action="<?= site_url('Accounts/Supplier/Save')?>" method="POST">
    <div class="row">
        ...
        <div class="panel-body">
            <div class="row col-lg-12">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="" name="NameE" style="width: 250px;" value="" type="text" autofocus required>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="form-group">
            ...
            <div class="row col-lg-12">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="" name="AddressE" style="width: 250px;" value="" type="text" autofocus>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="form-group">
            ...
            <div class="row col-lg-12">
                <div class="col-xs-4">
                    <div class="form-group">
                        <label class="control-label" for="inputSuccess">انکم ٹیکس آکاونٹس</label>
                        <select name="account" class="js-example-basic-multiple js-states form-control"  id="account_name">
                            <option>منتخب کیجیئے</option>
                            <?php foreach ($accounts as $account){?>
                                <option value="<?= $account->ch_id?>"><?= $account->parentName?> - <?= $account->AccountName?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        <label class="control-label" for="inputSuccess">ادائیگی کی نوعیت</label>
                        <input class="form-control" type="text" name="Nature_Of_Payment" style="width: 250px;" value="">
                    </div>
                </div>
            </div>
            <div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-6" style="margin-top: -3%;">
                                        <div class="form-group">
                                            <label class="control-label" for="inputSuccess">Name</label>
                                            <input class="form-control" id="NameE" name="Name" style="width: 250px;" value="" type="text" autofocus required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group" >
                                    <div class="col-xs-6" style="margin-top: -3%;">
                                        <div class="form-group">
                                            <label class="control-label" for="inputSuccess">Address</label>
                                            <input class="form-control" id="AddressE" name="Address" style="width: 250px;" value="" type="text" autofocus>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <label class="control-label" for="inputSuccess">ادائیگی کی نوعیت</label>
                                                <input type="text" class="form-control" id="Nature_Of_Payment" name="Nature_Of_Payment" style="width: 250px;" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <label class="control-label" for="inputSuccess">انکم ٹیکس آکاونٹس</label>
                                            <select name="account" class="js-example-basic-multiple js-states form-control" id="accounts_list">
                                                <option>منتخب کیجیئے</option>
                                                <?php foreach ($accounts as $account){?>
                                                    <option value="<?= $account->ch_id?>"><?= $account->parentName?> - <?= $account->AccountName?></option>
                                                <?php }?>
