...
<form role ="from" action="<?php echo site_url('Accounts/IncomeStatment/Get_Consolidated_IncomeStatement')?>" method="POST" target="_blank" id="UserInput">
    <br><h1 style="text-align: center;">مشترکہ آمدنی کا گوشوارہ</h1><br><br>
    <div style="border:1px solid #eee;
        ...
        <div style="line-height:10%;" class="row">
            ...
            <div class="form-group col-md-6" style="margin-top: 8px;">
                <label class="radio-inline">
                    <input type="radio" name="incomeof" id="incomeofp" value="p" checked>مستقل
                </label>
                <label class="radio-inline">
                    <input type="radio" name="incomeof" id="incomeofall" value="all"> مستقل+عارضی
                </label>
            </div>
            <div class="form-group col-md-6" style="margin-top: 8px;">
                <label class="radio-inline">
        ...
        <br><br>
        <input type="submit" name="get" id="get" class="button v_p" data-id="0" value="آمدنی کا گوشوارہ حاصل کریں ">
        ...
        <input style="margin-right: 2%;" type="submit" name="get" id="get" class="button v_p" data-id="1" value="آمدنی کا گوشوارہ پرنٹ کریں ">
        <?php }?>
    </div>
</form>
<style type="text/css">
