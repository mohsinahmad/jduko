...
<div class="content">
    <div class="row" id="content">
        ...
        <div style="text-align: center;">
            ...
            <h2 style="margin-top: 0px;text-decoration: underline; ">بیلنس شیٹ</h2>
            <h4><span><?= $from[0]->Qm_date?></span><span>  بمطابق  </span><span><?= $from[0]->Sh_date?></span></h4>
        </div>
    </div>
    <div class="level">
        <div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive" align="middle" style="width: 108%;text-align: center; margin-right: -5%;overflow-x: hidden;overflow-y: hidden;">
                                <table class="table-bordered">
                                    ...
                                    <tbody>
                                    <?php foreach ($Accounts as $key_1 => $level_1){
                                        if (is_numeric($key_1)){
                                                            ...
                                                            <?php if ($level_1->Category == '2' || $account_level == 'Detail' || $account_level == '1'){
                                                                ...
                                                                if ($t_id2 != array()){
                                                                    ...
                                                                    if ($balance < 0){
                                                                        ...
                                                                        <td style="width: 15%;"><span style="float:left;: left">CR</span><?= number_format($balance_new)?></td>
                                                                    <?php } else{?>
                                                                    ...
                                                                    <?php }else{?>
                                                                        <td style="width: 15%;"><?= number_format($balance)?></td>
                                                                    <?php }
                                                                }$balance_sum += $balance; $balance = 0; $count = $key_1;
                                                            }else{?>
                    ...
                    <table class="table-bordered" id="dataTables-example">
                        ...
                        <tr class="odd gradeX" style="line-height: 250%;">
                            ...
                            <?php if ($income_balance < 0){
                                ...
                                <td style="text-align: center">(<?= number_format($income_balance_new)?>)</td>
                            <?php }else{?>
                                <td style="text-align: center"><?= number_format($income_balance)?></td>
                            <?php } $total_balance = 0;?>
                        </tr>
                        <tr class="odd gradeX" style="line-height: 250%;">
                            ...
                            <?php if ($assists < 0){
                                ...
                                <td style="text-align: center"><span style="float: left">CR</span><?= number_format($assists_new)?></td>
                            <?php }else{?>
                                <td style="text-align: center"><?= number_format($assists)?></td>
                            <?php } $assists = 0; ?>
                        </tr>
                        </tbody>
                    </table>
