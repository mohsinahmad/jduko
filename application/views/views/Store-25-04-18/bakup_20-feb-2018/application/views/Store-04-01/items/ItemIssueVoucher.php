                        ...
                        <table style="border-radius: 25px;color: black; font-size: 13px;margin-top: 75px" border="" height="10" class="table-bordered">
                            ...
                            <?php foreach($IssueSlip as $key => $value):?>
                                <tr>
                                    ...
                                    <td style="width: 15%;text-align: center;" class="" style="text-align: center;" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $ApproveQuantity[$key]->Approve_Quantity;
