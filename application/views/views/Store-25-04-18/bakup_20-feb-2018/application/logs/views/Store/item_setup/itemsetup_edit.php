                ...
                <div class="row checkdonation" id="checkdonation">
                    ...
                    <div class="col-xs-3" style="left: -8%">
                        <div class="form-group">
                            ...
                            <input  class="form-control newOpeningQuanity" id="OpeningQuanity" name="OpeningQuanity[]" style="width: 250px;" value="<?= $item->opening_quantity?>" type="number" placeholder="ابتدائ مقدار" required>
                        </div>
                    </div>
                    <div class="col-xs-3" style="left: -14%">
                        <div class="form-group">
                            <label class="control-label" for="inputSuccess">موجود مقدار</label>
                            <input  class="form-control newCurrentQuanity" id="CurrentQuanity" name="CurrentQuanity[]" style="width: 250px;" value="<?= $item->current_quantity?>" type="number" placeholder="موجود مقدار" readonly>
                        </div>
                    </div>
