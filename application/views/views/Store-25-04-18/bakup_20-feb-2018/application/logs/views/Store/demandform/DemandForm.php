                ...
                <div class="table-responsive" style="width: 100%;">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php foreach ($demands as $value): ?>
                            <tr data-id='<?php echo $value->d_id?>'>
                                <td style="text-align: center"><?php echo $value->Form_Number?></td>
                                <td style="text-align: center"><?php echo $value->LevelName?></td>
                                <td style="text-align: center"><?php echo $value->Form_DateG?></td>
                                <td style="text-align: center"><?php echo $value->Form_DateH?></td>
                                <td style="width: 10%;vertical-align: middle;text-align: center"><?php if($value->Status == 0) {?>
                                ...
                                <td>
                                    <a target="_blank" href="<?php echo site_url('Store/DemandForm/ViewVoucher').'/'.$value->d_id;?>" <button type="button"  data-id="<?php echo $value->d_id; ?>" class="btn btn-success " style="background-color: #517751;border-color: #517751;"><i class="fa fa-print"></i>
                                    </button></a>
                                    <?php if ($value->Status == 0){?>
                                    <a href="<?php echo site_url('Store/DemandForm/FormEdit').'/'.$value->d_id?>" <button type="button"  data-id="<?php echo $value->d_id; ?>" class="btn btn-success " style="background-color: #517751;border-color: #517751;"><i class="fa fa-pencil-square-o"></i></button></a><?php }?>
                                </td>
                            </tr>
                        <?php endforeach?>
                        </tbody>
