...
<div class="content">
    <div class="row" id="content">
        ...
        <div style="text-align: center;">
            ...
            <h2 style="margin-top: 0px;font-size: 20px">علاقائی تفصیلات</h2>
    ...
    <div class="level">
        ...
        $final_total_Fresh_Cow=$final_total_Old_Cow=$final_total_Fresh_Goat=$final_total_Old_Goat=$final_total_Fresh_Sheep=$final_total_Old_Sheep=$final_total_Fresh_Camel=$final_total_Old_Camel=$final_total_Fresh_Buffalo=$final_total_Old_Buffalo=$final_Fresh=$final_Old =0;
                                ...
                                <table class="table-bordered">
                                    ...
                                    <tr style="line-height: 150%;">
                                        ...
                                        <th style="text-align: center">
													<span><?= number_format($Cow_Fresh_Total);
                                                        $total_fresh_Cow += $Cow_Fresh_Total; ?></span><br>
                                            <span><?= number_format($Cow_Old_Total);
                                                $total_old_Cow += $Cow_Old_Total ?></span>
                                        </th>
                                        <th style="text-align: center">
													<span><?= number_format($Goat_Fresh_Total);
                                                        $total_fresh_Goat += $Goat_Fresh_Total; ?></span><br>
                                            <span><?= number_format($Goat_Old_Total);
                                                $total_old_Goat += $Goat_Old_Total; ?></span>
                                        </th>
                                        <th style="text-align: center">
													<span><?= number_format($Sheep_Fresh_Total);
                                                        $total_fresh_Sheep += $Sheep_Fresh_Total; ?></span><br>
                                            <span><?= number_format($Sheep_Old_Total);
                                                $total_old_Sheep += $Sheep_Old_Total; ?></span>
                                        </th>
                                        <th style="text-align: center">
													<span><?= number_format($Camel_Fresh_Total);
                                                        $total_fresh_Camel += $Camel_Fresh_Total; ?></span><br>
                                            <span><?= number_format($Camel_Old_Total);
                                                $total_old_Camel += $Camel_Old_Total ?></span>
                                        </th>
                                        <th style="text-align: center">
													<span><?= number_format($Buffalo_Fresh_Total);
                                                        $total_fresh_Buffalo += $Buffalo_Fresh_Total; ?></span><br>
                                            <span><?= number_format($Buffalo_Old_Total);
                                                $total_old_Buffalo += $Buffalo_Old_Total
                                                ?></span>
                                        </th>
                                        <th style="text-align: center">
													<span><?= number_format($fresh_quantity_total_sum);
                                                        $total_All_sum_Fresh += $fresh_quantity_total_sum
                                                        ?></span><br>
                                            <span><?= number_format($old_quantity_total_sum);
                                ...
                                <?php if (isset($hulqy[$key+1])) {
                                    if ($hulqy[$key+1]->Type != $hulqy[$key]->Type) { ?>
                                        <div class="panel-body" style="direction: rtl;">
                                            <div class="table-responsive" style="width: 104%;margin-right: -2%;">
