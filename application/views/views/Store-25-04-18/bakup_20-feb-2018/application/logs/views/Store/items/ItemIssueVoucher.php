            ...
            <div class="container-fluid" >
                <div class="table-responsive">
                    <table style="border-radius: 25px;color: black; font-size: 13px;margin-top: 75px" border="" height="10" class="table-bordered">
                        <thead>
                        <tr>
                            <th style="width: 25%;border-top-left-radius: 20px;" colspan="" bordercolorlight="#000000" bordercolordark="#000000">کیفیت</th>
                            ...
                            <th style="border-top-right-radius: 20px;" colspan="1" bordercolorlight="#000000" bordercolordark="#000000">نمبرشمار</th>
                        ...
                        <tr>
                            <td style="width: 15%" class="remarks" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $value->Remarks?></td>
                            <td style="width: 15%;text-align: center;" class="" style="text-align: center;" bordercolorlight="#000000" bordercolordark="#000000"><?php echo $value->Approve_Quantity;
                                $totalissue += $value->Approve_Quantity;
                            ?></td>
                    ...
                    <?php endforeach?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?=number_format($totalissue,2)?></td>
                            <td style=""><b>:کل</b></td>
