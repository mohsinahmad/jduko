...
<form role ="from" action="<?php echo site_url('Accounts/IncomeStatment/GetValue')?>" method="POST" target="_blank" id="UserInput">
    <br><h1 style="text-align: center;">آمدنی کا گوشوارہ</h1><br><br>
