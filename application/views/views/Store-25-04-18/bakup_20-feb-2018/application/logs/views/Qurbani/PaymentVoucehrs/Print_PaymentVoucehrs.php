    ...
    <div class="level">
        <div style="margin-right: 2%;">
            <div>
                ...
                <input type="text" class="VoucherMOdal" name="" style="width: 30%;text-align: center;" value="<?php echo $vouchers[0]->VoucherNumber?>" readonly>
            </div>
            <div style="">
                <label class="label-control">ادائیگی بنام:</label>
                <input type="text" class="VoucherMOdal" name="" style="width: 29.5%;text-align: center;line-height: 0;" value="<?php echo $vouchers[0]->Name?>" readonly>
            </div>
            <div style="margin-right: 65%;margin-top: -8.5%;">
                <label class="label-control">عیسوی تاریخ:</label>
                <input type="text" class="VoucherMOdal" name="" style="width: 55%;text-align: center;" value="<?php echo $vouchers[0]->DateG?>" readonly>
            </div><br><br>
            <div style="margin-right: 65%;margin-top: -3.5%;">
                <label class="label-control">ہجری تاریخ:</label>
                <input type="text" class="VoucherMOdal" name="" style="width: 57%;text-align: center;" value="<?php echo $vouchers[0]->DateH?>" readonly>
            </div>
            <div style="margin-top: 2%;">
                <label class="label-control">رقم ہندسوں میں:</label>
                <input type="text" class="VoucherMOdal" name="" style="width: 25.6%;text-align: center;" value="=/<?php echo number_format($vouchers[0]->Amount) ?>" readonly>
            </div>
            <div style="margin-right: 40%;margin-top: -4.5%;">
                <label class="label-control">رقم عبارت میں:</label>
                <input type="text" class="VoucherMOdal" name="" style="width: 69.5%;text-align: center;line-height: 0%;" value="<?php echo $AmountInWords?>" readonly>
            </div>
            <div style="margin-bottom: 4%;">
                <label class="label-control">بابت:</label>
                <textarea rows="2" cols="80" type="text" class="VoucherMOdal" readonly="" style=" font-family: 'Noto Nastaliq Urdu', serif;width: 89%;overflow:hidden;"><?php echo $vouchers[0]->Description?></textarea>
            </div>
            <div>
