                                ...
                                <div class="form-group col-md-4 Jv" >
                                    <div class="col-sm-2">
                                        <label class="col-sm-2 control-label">رقم ہندسوں میں :
                                            <input type="text" class="VoucherMOdal" readonly style="font-family: 'Noto Nastaliq Urdu', serif; width: 230px;" value="">
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 Jv">
                        ...
                        <table style="border-radius: 25px;color: black; font-size: 13px;margin-top: 75px" border="1" height="10" class="table-bordered">
                            ...
                            foreach($IssueSlip as $key => $stock): ?>
                                <tr>
                                    ...
                                    <td style="width: 15%" style="text-align: center;" class="remarks" bordercolorlight="#000000" bordercolordark="#000000"></td>
