                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <?php $submit_date = $vouch[0]->VoucherDateH ;
                            $submit_dateG = $vouch[0]->VoucherDateG ;
                            $dateHFormateG = $submit_dateG[8].$submit_dateG[9].'-'.$submit_dateG[5].$submit_dateG[6].$submit_dateG[4].$submit_dateG[0].$submit_dateG[1].$submit_dateG[2].$submit_dateG[3];
                            $dateHFormateH = $submit_date[8].$submit_date[9].'-'.$submit_date[5].$submit_date[6].$submit_date[4].$submit_date[0].$submit_date[1].$submit_date[2].$submit_date[3];
                            ?>
                            <?php if(isset($vouch[0]->DepartmentName)){
                                $depart = $vouch[0]->DepartmentName;
                            }else{
                                $depart = $vouch[0]->LevelName;
                            }
                            ?>
                            <td style="direction: rtl;float: right;padding-bottom: 0px;margin-top: -6%;">
                                <div class="form-group col-md-4">
                                    <div class="col-sm-2">
                                        <label class="col-sm-2 control-label">آمدنی برائے شعبہ<span style="margin-right: 11px;">:</span>
                                            <input type="text" class="VoucherMOdal" style="font-family: 'Noto Nastaliq Urdu', serif; width: 178px;font-weight: bold;font-size: 1em" value="<?=$depart?>" readonly>
                                        </label>
                                    </div>
                                </div>
                            </td>
                            <td style="direction: rtl;float: right;margin-bottom: 6%;">
                                <div class="form-group col-md-4">
                                    <div class="col-sm-2">
                                        <label class="col-sm-2 control-label">رقم جمع کروانے کی ہجری تاریخ<span style="margin-right: 11px;">:</span>
                                            <input type="text" class="VoucherMOdal" readonly style="font-family: 'Noto Nastaliq Urdu', serif; width: 147px;font-weight: bold;font-size: 1em" value="<?php echo $dateHFormateH?>">
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <div class="col-sm-2">
                                        <label class="col-sm-2 control-label">رقم جمع کروانے کی عیسوی تاریخ<span style="margin-right: 6px;">:</span>
                                            <input type="text" class="VoucherMOdal" readonly style="font-family: 'Noto Nastaliq Urdu', serif; width: 145px;font-weight: bold;font-size: 1em" value="<?php echo $dateHFormateG?>">
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <td>
                                    <div class="form-group col-md-2" style="float: left;width: 345px;">
                                        <label class="col-sm-1 control-label">نقد:
                                            <input type="text" class="VoucherMOdal" value="<?=number_format($AmountDescriptionCash);?>" style="width: 218px;font-weight: bold;font-size: 1em" readonly></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group col-md-2" style="float: left;width: 345px;">
                            ...
                            <tr style="direction: rtl;">
                                <td>
                                    <div class="form-group" style="">
                                        <label class="control-label"> کیشئر: </label>
                                        <input type="text" class="VoucherMOdal" style="width: 154px;" readonly>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group" style="">
                                        <label class="control-label">  دستخط اکاؤنٹنٹ: </label>
                                        <input type="text" class="VoucherMOdal" style="width: 170px;" readonly>
                                    </div>
                                </td>
                                <td style="">
                                    <div class="form-group" style="">
                                        <label class="control-label">دستخط جمع کنندہ:</label>
                                        <input type="text" class="VoucherMOdal" style="width: 187px;" readonly>
                                    </div>
                                </td>
                            </tr>
                        </table>
