...
if(isset($type)):
    foreach($transactions as $transaction):
        foreach($transaction as $key => $transaction_2): ?>
            <tr class="odd gradeX">
                ...
                <td><?php ($this->uri->segment(3) === "permanentVoucher")?$vouch_type = 1: $vouch_type = 0;
    ...
    foreach($transactions as $key => $transaction): ?>
        <tr class="odd gradeX">
            <td style="width: 61.0078px"><?= $transaction->Permanent_VoucherNumber?>-<?= $transaction->VoucherType?></td>
