...
<?php }?>
 ...
 <div class="modal fade" id="loader" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">برائے مہربانی انتظار فرمائیں</h4>
        </div>
        <div class="modal-body">
        <center>  <i class="fa fa-spinner fa-spin" style="font-size:72px"></i></center>
        </div>
