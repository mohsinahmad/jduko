...
<form role ="from" action="<?= site_url('Accounts/TaxDeductionReport/index/2')?>" method="POST" target="_blank" id="UserInput">
    <br><h1 style="text-align: center;">ٹیکس کٹوتی کی تفصیلات</h1><br><br>
    <div style="border:1px solid #eee;
        ...
        <br><br>
        <input type="submit" id="get" class="button" data-id="0" value="رپورٹ حاصل کریں">
    </div>
</form>
