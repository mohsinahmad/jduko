...
<div class="content">
    <div class="row" id="content">
        ...
        <div style="text-align: center;">
            ...
            <?php if ($B_Sheet_Of == 'p'){ ?>
                <h2 style="font-size: 22px;margin-top: 15px;text-decoration: underline; ">بیلنس شیٹ<span style="font-size: 13px">(مستقل)</span></h2>
            <?php }else{ ?>
                <h2 style="font-size: 22px;margin-top: 15px;text-decoration: underline; ">بیلنس شیٹ<span style="font-size: 13px">(عارضی + مستقل)</span></h2>
            <?php }?>
                                                                                                    ...
                                                                                                    <?php if ($level_6->Category == '2' || $account_level == '6'){
                                                                                                        ...
                                                                                                        if ($t_id2 != array()){
                                                                                                            ...
                                                                                                            if ($balance < 0){
                                                                                                                ...
                                                                                                                <td style="width: 15%;">(<?= number_format($balance_new)?>)</td></tr>
                                                                                                            <?php }else{?>
                                                                                                                <td style="width: 15%;"><?= number_format($balance)?></td></tr>
                                                                                                            <?php } }else{
                                                                                                            if ($balance < 0){
                                                                                                                $balance_new = $balance * -1; ?>
                                                                                                                <td style="width: 15%;">(<?= number_format($balance_new)?>)</td></tr>
                    ...
                    <table class="table-bordered" id="dataTables-example">
                        ...
                        <tr class="odd gradeX" style="line-height: 250%;">
                            ...
                            <?php if ($assists < 0){
                                ...
                                <td style="width:24%;text-align: center"><span style="float: left">CR</span><?= number_format($assists_new)?></td>
                            <?php }else{?>
