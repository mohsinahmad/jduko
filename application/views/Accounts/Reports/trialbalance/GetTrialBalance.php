...
<form role ="from" action="<?php echo site_url('Accounts/TrialBalance/getTrailBalance')?>" method="POST" target="_blank" id="UserInput">
    <br><h1 style="text-align: center;">ٹرایل بیلنس</h1><br><br>
    <div style="border:1px solid #eee;
        ...
        <br><br>
        <input type="submit" id="get" class="button v_p" data-id="0" value="ٹرایل بیلنس حاصل کریں">
        ...
        <input type="submit" id="get" class="button v_p" data-id="1" value="ٹرایل بیلنس پرنٹ کریں">
        <?php }?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //var level = '<?//= $this->session->userdata('comp');?>';
        var level = $('#comp').val();
        $.ajax({
            type:'GET',
