...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default" style="margin-top: -13%;">
            ...
            <!--<button style="cursor: pointer" id="show_year">Closing Year</button>-->
            <?php }?>
            <div class="panel-heading">
...
<!--                <h4 class="modal-title">Closing Year</h4>-->
<!--            </div>-->
<!--            <div class="modal-body">-->
<!--                <input type="text" id="year_data">-->
<!--            </div>-->
<!--            <div class="modal-footer">-->
<!--                <button class="btn btn-primary" id="year_close" type="button">Save</button>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
...
<script type="text/javascript">
    ...
    //      $.ajax({
    //         url:'<?php echo base_url()?>Accounts/Books/update_year',
    //         data:{'year':$('#year .modal-body > input[type=text]').val()},
    //         type:'post',
