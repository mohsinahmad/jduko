<form role ="from" action="<?= site_url('Qurbani/ChrumQuantity/ViewComparative_report')?>" method="POST" target="_blank" id="UserInput">
    <br><h1 style="text-align: center;">تقا بلی جائزے کی رپورٹ</h1><br><br>
