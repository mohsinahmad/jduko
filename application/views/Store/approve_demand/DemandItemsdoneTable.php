...
//                    console.log(data['donation_type'][index]);
                    ...
                    if (index == 0){
                        ...
                        $('.items').append('<div class="row itemsRow">' +
                            ...
                            '<input class="form-control a_quantity ApproveQuan'+index+'" id="ApproveQuantity'+index+'" name="" style="padding-left: 0px;padding-right: 0px;text-align: center;" type="text">' +
                            '</div>' +
                            '</div>' +
...
//            total =+ demand_quantity - approved_quantity;
    ...
    $('.Approve').on('click',function(){
        ...
        var AQuan;
        var items = $('.itemsRow').length;
        var Demand = $('#ApproveQuantity0').val();
