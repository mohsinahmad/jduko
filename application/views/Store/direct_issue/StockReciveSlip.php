<div class="row">
    <div class="col-lg-12">
        <br>
        <h1 class="page-header" style="margin-top: 10px;">فوری اجراء آرکئیو</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="panel-heading col-md-12" style="width: 100%;">
                <div class="row">
                    ...
                    <div class="input-group col-md-3"  style="float: left; direction: ltr;">
                        ...
                        <label class="input-group-addon"> فوری اجراء آرکئیو </label>
                    </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php foreach($stock as $value):?>
                            <tr data-id='<?php echo $value->s_id ?>'>
                                ...
                                <td style="text-align: center"><?php echo $value->NameU?$value->NameU:'ابتدائی کی گئی'?></td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger delete_direct_issue" data-id="<?php echo $value->s_id;?>" style="font-size: 10px; ">حذف کریں
                                    </button>
                                  <!--   <a href="<?php echo site_url('Store/StockSlip/Update_Stock').'/'.$value->s_id; ?>" <button type="button"  data-id="<?php echo $value->s_id; ?>" class="btn btn-success " style="font-size: 10px;background-color: #517751;border-color: #517751; "></button>تصیح کریں</a> -->
                                    <a target="_blank" href="<?php echo site_url('Store/StockSlip/get_direct_issue_report').'/'.$value->s_id;?>"> 
