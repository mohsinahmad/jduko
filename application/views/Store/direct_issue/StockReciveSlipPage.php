...
<form action="<?= site_url('Store/StockSlip/Save_direct_issue')?>" method="post">
    <div class="row">
...
//        }
        ...
        if(!error){
            post.name = 'Item';
                ...
                post.unit = $('#unit').val();
                post.category = $('#sub-category').val();
                // alert(post.donationid);
                ...
                $('tbody').append('<tr class="addnew">' +
                    ...
                    '</td>' +
                    '<input type="hidden" class="unit" name="unit[]" value='+post.unit+'>' +
                    '</td>' +
                    '<input type="hidden" class="category" name="category[]" value='+post.category+'>' +
                    '</td>' +
