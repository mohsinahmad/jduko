                        ...
                        <table class="table table-striped table-bordered table-hover" id="data-table">
                            ...
                            <tbody class="toEdit">
                                ...
                                <tr>
                                    ...
                                    <td style="display: none"><input type="hidden" name="donation" value="<?php echo $slip->donation_type?>"></td>
                                    <td style="display: none"><input type="hidden" name="item_detail" value="<?php echo $slip->item_setup_detail_id?>"></td>
                                    <td style="display: none"><input type="hidden" name="recieveslip_detail[]" value="<?php echo $slip->recieve_slip_detail_id?>"></td>
                                    <td class="center"><button type="button" class="btn btn-info btn-circle del" ><i class="fa fa-minus"></i></button>
                                    <button type="button" class="btn btn-info btn-circle edit" id="toEdit<?php echo ++$count?>" ><i class="fa fa-plus"></i></button></td>
                                </tr>
                                <?php } ?>    
                            </tbody>
                        </table>
