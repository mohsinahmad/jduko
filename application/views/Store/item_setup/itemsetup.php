...
<script>       
    ...
    function printData()
    {
        ...
        $('#dataTables-example tbody tr').each(function () {
            var chek_0 = $(this).children('td').eq(7).html();
            if(chek_0 == 0){
    ...
    $(document).ready(function () {
        ...
        var check_auto  =  '<?php echo $this->uri->segment(4)?>';
        ...
        if(check_auto == 'auto'){
                    var category = '<option selected value="'+localStorage.getItem("item_category_id")+'">'+localStorage.getItem("item_category_name")+'</option>';
                $('#Category').append(category);
                    var subcategory = '<option selected value="'+localStorage.getItem("sub_category_id")+'">'+localStorage.getItem("sub_category_name")+'</option>';
                $('#sub-category').append(subcategory);
                $('#sub-category').removeAttr('disabled');
                         var item = '<option selected value="'+localStorage.getItem("itemid")+'">'+localStorage.getItem("itemname")+'</option>';
                $('#items').append(item);
                $('#items').removeAttr('disabled');
                   var donation = '<option selected value="'+localStorage.getItem("donationid")+'">'+localStorage.getItem("donationname")+'</option>';
                   alert(donation);
                $('#DonationType').append(donation);
                $('#OpeningQuanity').val(localStorage.getItem("openig"));
                $('#OpeningQuanity').trigger('keyup');
                $('#add').trigger('click');
                localStorage.clear();
        }
