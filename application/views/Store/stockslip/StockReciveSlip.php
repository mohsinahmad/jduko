<div class="row">
                        ...
                        echo "<div class='col-md-12 alert alert-success'><p class='text-success'>".$this->session->flashdata('success').'</p></div>';
                       }elseif($this->session->flashdata('error')){
                        echo "<div class='col-md-12 alert alert-danger'><p class='text-danger'>".$this->session->flashdata('error').'</p></div>';
                       } ?>
    <div class="col-lg-12">
        <br>
