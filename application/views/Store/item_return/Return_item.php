            ...
            <div class="panel-body">
                <div class="table-responsive" style="width: 100%;">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                        <tr>
                            <th style="text-align: center;width: 50.021px;">جاری شدہ فارم نمبر</th>
                            <th style="text-align: center;width: 60.021px;">ڈیمانڈ نمبر</th>
                        ...
                        <?php foreach ($issued as $value): ?>
                            <tr data-id='<?= $value->Id?>'>
                                ...
                                <td style="text-align: center"><?= $value->demand_no?></td>
                                ...
                                <td style="text-align: center"><?php if($value->Status == 3){?>
                                    ...
                                    <?php }?>
                                    <a target="_blank" href="<?= site_url('Store/ItemReturn/View_Voucher').'/'.$value->Id.'/';?>" <button type="button" data-id="<?= $value->Id; ?>" class="btn btn-success" style="background-color: #517751;border-color: #517751;"><i class="fa fa-print"></i></button></a>
                                </td>
                            </tr>
                        <?php endforeach?>
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary getid">موصول</button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    $('.ShowTime').on('click',function(){
        ...
        $.ajax({
            ...
            url:'<?php echo site_url('Store/ItemIssue/GetIssuedItem');?>'+'/'+id,
