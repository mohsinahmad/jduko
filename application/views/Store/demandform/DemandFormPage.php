                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <div class="form-group" style="align-content: center;">
                                ...
                                <select class="form-control" disabled required id="Category" style="height: 50px;" name="Category">
...
<div id="error_popup" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <p class="text-danger">
اس آٹٹم کی موجودہ مقدار مطلوبہ مقدار سے کم ہے جبکہ موجودہ مقدار : <span id="current_qty"></span> ہے ۔
 <span id="current_qty"></span> </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success"> <a style="text-decoration: none;color: white;" href="<?php echo base_url()?>Store/items/ItemSetup/" target="_blank">  آئٹم سیٹ اپ پر جائیں  </a> </button>
            </div>
        </div>
    </div>
</div>
...
<div id="error_qty_popup" data-backdrop="static" data-keyboard="false" class="modal fade" role="dialog" aria-labelledby="gridModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <p class="text-danger"> آپ اس آئٹم کی ٹوٹل مقدار شامل کار چکے ہیں۔  </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success"> <a style="text-decoration: none;color: white;" href="<?php echo base_url()?>Store/items/ItemSetup/" target="_blank">  آئٹم سیٹ اپ پر جائیں  </a> </button>
            </div>
       ...
       $.ajax({
           ...
           success:function(response){
               ...
               if(result[0].current_quantity == null){
                 ...
                 $("#dataInsert").attr("disabled","true");
               }
               else if(result[0].current_quantity < parseFloat($("#Quantity").val())){
                    var val = result[0].current_quantity;
                    $("#current_qty").html(val);
                    $("#error_popup").modal("show");
                    $("#dataInsert").attr("disabled","true");
               }
               else{                
                $(".ItemName").each(function(i,e){                    
                    if($("#ItemName option:selected").text() == $(this).eq(i).val()){
                        debugger;
                      total_quantity += parseInt($(".Quantity").eq(i).val());
                      var remain_quantity = (result[0].current_quantity - total_quantity);
                      if(parseInt($("#Quantity").val()) > remain_quantity){
                        $("#error_qty_popup").modal("show");
                        $("#dataInsert").attr("disabled","true");
                      }else{
