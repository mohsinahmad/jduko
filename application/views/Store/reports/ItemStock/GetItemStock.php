...
<div class="alert alert-danger alert-dismissable" style="display: none" id="lalert">
    <?php echo $this->session->flashdata('message_name');?>
</div>
<?php } ?>

<form role ="from" action="<?php echo site_url('Store/ItemStock/GetItemStock')?>" method="POST" target="_blank" id="UserInput">
    <br><h1 style="text-align: center;">  لیجر  </h1><br><br>
    <div style="border:1px solid #eee;
        ...
        <div style="line-height:10%;" class="row">
            <div class="col-md-10">
                ...
                <select name="category" required class=" js-example-basic-single1 form-control category" id="category" style="padding-bottom: 0px;padding-top: 0px;" >
            ...
            <!-- <div class="col-md-6">
                ...
                <select name="donation" required class="js-example-basic-single1 form-control  donation" id="donation" style="padding-bottom: 0px;padding-top: 0px;" >
                    <option value="" disabled selected>منتخب کریں</option>
        ...
        <div  class="row">
            <div class="col-md-6">
                ...
                <select  multiple="" name="item[]" class="js-example-basic-multiple js-states form-control select2-selection--multiple"  id="itemlist" > <!-- multiple="multiple" -->
            ...
            <div style="" class="col-md-6">
                ...
                <input type="hidden" id="to" name="from">
                <input type="hidden" id="from" name="to">
            </div>
        ...
        if($_SESSION['user'][0]->IsAdmin == 1 || ($rights != array() && $rights[0]->Rights[5] == '1')){?>
            <input type="submit" style="line-height: 210%" name="get" id="get" class="" data-id="1" value="ر   پورٹ حاصل کریں">
        <?php }?>
