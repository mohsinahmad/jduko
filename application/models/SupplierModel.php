...
class SupplierModel extends CI_Model
{
    ...
    public function GetSupplierById($id)
    {
                ...
                $this->db->join('donation_type','donation_type.id = item_stockrecieve_slip_details.donation_type');
